            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2" style="display: flex; align-items: center; justify-content: center; margin-left: 20px; margin-right: 10px;">
    <img src="{{ asset('assets/img/icons/brands/KPU_Logo.svg.png') }}" alt="Logo" style="width: 50px; height: 50px; margin-right: 10px; margin-left: -35px;">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="#"><i class="bx bx-power-off me-2"></i><span
                                                class="align-middle">Log Out</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
...
<div class="card mb-4">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <small class="text-muted float-end">Form untuk mengedit surat keluar</small>
    </div>
    <div class="card-body">
        <form id="formSuratKeluar" action="{{ route('suratkeluar.update', $surat->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
...
document.getElementById('btnSubmit').addEventListener('click', function (e) {
    ...
    const requiredFields = document.querySelectorAll('#formSuratKeluar input[required]');
    let allFilled = true;
    ...
    if (allFilled) {
        ...
        Swal.fire({
            ...
            document.getElementById('formSuratKeluar').submit();
        });
    } else {
