            ...
            <div class="col-xxl">
              <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                  ...
                  <small class="text-muted float-end">Form untuk menambahkan surat keluar</small>
                </div>
                <div class="card-body">
                <form id="formSuratKeluar" action="{{ route('suratkeluar.store') }}" method="POST" enctype="multipart/form-data">
  @csrf
  <!-- Nomor Surat -->
  <div class="row mb-3">
...
<script>
  document.getElementById('btnSubmit').addEventListener('click', function (e) {
    ...
    if (!nomorSurat || !tanggalSurat || !tujuanSurat || !perihalSurat || !file) {
      ...
      if (!datePattern.test(tanggalSurat)) {
        Swal.fire({
          title: 'Gagal!',
          text: 'Tanggal surat harus dalam format yyyy-mm-dd!',
          icon: 'error',
          confirmButtonText: 'OK'
        });
      } else {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            Swal.fire({
              ...
              document.querySelector('#formSuratKeluar').submit();
            });
          }
        });
      }
