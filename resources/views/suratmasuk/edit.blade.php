                ...
                <div class="content-wrapper">
                    <div class="container">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('surat_masuk.update', $surat->id) }}" method="POST"
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" name="nomor_surat" id="nomor_surat"
                                                    class="form-control" value="{{ $surat->nomor_surat }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Tanggal Surat -->
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="date" name="tanggal_surat" id="tanggal_surat"
                                                    class="form-control" value="{{ $surat->tanggal_surat }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Tujuan Surat -->
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" name="tujuan_surat" id="tujuan_surat"
                                                    class="form-control" value="{{ $surat->tujuan_surat }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Perihal Surat -->
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" name="perihal_surat" id="perihal_surat"
                                                    class="form-control" value="{{ $surat->perihal_surat }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- File Surat -->
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <small>File yang sudah diupload: {{ $surat->nama_file }}</small>
                                        </div>
                                    </div>
                                    <!-- Submit Button -->
