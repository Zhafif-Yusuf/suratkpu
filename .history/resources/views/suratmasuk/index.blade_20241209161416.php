...
<body>
  ...
  <h4 class="card-header" style="color:#313232">Surat Masuk</h4>
  <div class="card-body">
    @if (session('success'))
    ...
    <a href="{{ route('suratmasuk.create') }}" class="btn btn-primary mb-3">+ Input Surat Masuk</a>
        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    @if($surat->user_id === auth()->user()->id) <!-- Check if the user is the owner -->
                        <a href="{{ route('surat_masuk.edit', $surat->id) }}" class="dropdown-item">
                            <i class="bx bx-edit-alt me-1"></i> Edit
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item"
                           onclick="deleteItem('{{ route('surat_masuk.destroy', $surat->id) }}')">
                            <i class="bx bx-trash me-1"></i> Delete
                        </a>
                    @endif
                    <a class="dropdown-item" href="{{ asset('storage/' . $surat->file) }}" 
                       download="{{ $surat->nama_file }}">
  ...
  function deleteItem(url) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // Notifikasi berhasil sebelum penghapusan
        Swal.fire({
          title: 'Berhasil!',
